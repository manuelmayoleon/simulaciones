    ...
    if i % cut == 0:
        ...
        if t[i] > 50:#max(5*tau, 5*Tm):
            ...
            for q in index:
                ...
                rhox_inst = np.mean(Xi[bact_bin])
                Q1_inst = np.mean(np.cos(2*thetai[bact_bin]))
                Q2_inst = np.mean(np.sin(2*thetai[bact_bin]))
                JX1_inst = np.mean(np.cos(thetai[bact_bin])*Xi[bact_bin])
                JX2_inst = np.mean(np.sin(thetai[bact_bin])*Xi[bact_bin])
                Jx_inst = np.mean(V*np.cos(thetai[bact_bin]))
                Jy_inst = np.mean(V*np.sin(thetai[bact_bin]))
...
plt.xlabel('y')
plt.ylabel(r'$\rho(y)$')
# plt.savefig('Fields\Bacterial density profile\c1 = {:04.1f} Tm = {:04.1f}.png'.format(c1,Tm),dpi=200)
plt.show()

# Perfil de densidad de bacterias en escala semilog
...
plt.xlabel('y')
plt.ylabel(r'$\rho(y)$')
# plt.savefig('Fields\Bacterial density profile\c1 = {:04.1f} Tm = {:04.1f} (semilog).png'.format(c1,Tm),dpi=200)
plt.show()
...
# plt.savefig('Fields\X density profile\c1 = {:04.1f} Tm = {:04.1f}.png'.format(c1,Tm),dpi=200)
plt.show()
...
# plt.savefig('Fields\Q1\c1 = {:04.1f} Tm = {:04.1f}.png'.format(c1,Tm),dpi=200)
plt.show()
...
# plt.savefig('Fields\Q2\c1 = {:04.1f} Tm = {:04.1f}.png'.format(c1,Tm),dpi=200)
plt.show()
...
# plt.savefig('Fields\JX\JX_x\c1 = {:04.1f} Tm = {:04.1f}.png'.format(c1,Tm),dpi=200)
plt.show()
...
# plt.savefig('Fields\JX\JX_y\c1 = {:04.1f} Tm = {:04.1f}.png'.format(c1,Tm),dpi=200)
plt.show()

#Campo f12
plt.plot(yfield,f12_mean)
plt.xlabel('y')
plt.ylabel(r'$\langle$X cos(2$\theta$)$\rangle$')
plt.tight_layout()
# plt.savefig(r'Fields\f_12\c1 = {:04.1f} Tm = {:04.1f}.png'.format(c1,Tm),dpi=200)
plt.show()
